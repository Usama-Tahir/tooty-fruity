...
exports.router = router => {
   ...
   */
  router.post('/v1/media/categories', Middleware.hasRole('admin'), categoryController.create, Middleware.Response.success('mediaCategory'));
   ...
   * @apiPermission user
   */
  router.get('/v1/media/search', Middleware.isAuthenticated, mediaController.search, Middleware.Response.success('search'));
